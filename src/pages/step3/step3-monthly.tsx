...
const ThirdStepMonthly: React.FC = () => {
  ...
  // Add-ons data
  const addOns = [
    { id: 'onlineService', title: 'Online service', description: 'Access to multiplayer games', price: 1 },
    { id: 'largerStorage', title: 'Larger storage', description: 'Extra 1TB of cloud save', price: 2 },
    { id: 'customProfile', title: 'Customizable profile', description: 'Custom theme on your profile', price: 2 },
  ];
...
<div className="third-step-container">
 ...
 export default ThirdStepMonthly;